...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should reject invalid addresses" do
    invalid_addresses = %w[user@example,com user_at_foo.org user.name@example. foo@bar_baz.com foo@bar_baz..com foo@bar+baz.com]
  ...
  test "should follow and unfollow a user" do
    user1 = users(:example_user3)
    user2  = users(:example_user4)
  ...
  test "feed should have the right posts" do
    user1 = users(:example_user)
    user2 = users(:example_user5)
    user3 = users(:example_user6)
